...
func (r gatewayApiConfig) Flags(flags *pflag.FlagSet) {
	...
	flags.Bool("enable-gateway-api-http3", r.EnableGatewayAPIHTTP3, "Enables HTTP/3 (QUIC) support for Gateway API HTTPS listeners")
...
func initGatewayAPIController(params gatewayAPIParams) error {
	...
	cfg := translation.Config{
		...
		HTTP3Enabled: params.GatewayApiConfig.EnableGatewayAPIHTTP3,
	}
